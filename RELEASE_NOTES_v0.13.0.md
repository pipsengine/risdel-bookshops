# Risdel Books v0.13.0 — Module 12 Supplier Management
...
Run `npm run sheets:init` against the existing Risdel Books spreadsheet. The initializer is additive and preserves previous module data.
